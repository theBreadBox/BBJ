...
contract BakedBlueJays is ERC721A, Ownable {
    ...
    string public constant NR = "ipfs://HIDDEN_METADATA/";
...
////Public Functions
    ...
    
    {
        ...
        require(msg.value > (qty-1) * _cost, "Not Enough ETH");
    ...
    function preSaleMint(uint qty) external payable
    {
        ...
        require(tm + qty < 10001, "Nest is empty");
        require(msg.value > 41999999999999999 * qty, "Not Enough ETH");
 ...
 //// metadata URI
    ...
    function tokenURI(uint tokenId) public view virtual override returns (string memory) 
    {
      if(revealed == false) 
      {
        return bytes(NR).length > 0
        ? string(abi.encodePacked(NR, tokenId.toString(), ".json"))
        : "";
      }
